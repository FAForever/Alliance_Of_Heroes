...
--- Alliance of Heroes Cold beam

ColdBeam = Class(MicrowaveLaserCollisionBeam01) {
    TerrainImpactScale = 0.25,
    TerrainImpactScale = 1,
    FxBeamStartPoint = EffectTemplate.ColdwaveLaserMuzzle01,
    FxBeam = {ModPath..'Cold_laser_beam_01_emit.bp'},
    FxBeamEndPoint = EffectTemplate.ColdwaveLaserEndPoint01,
}
