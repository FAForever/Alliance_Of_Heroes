...
function ResearchLaunch()
	if self:IsChecked() then
        ...
        local modeData = {
            name="RULEUCC_Research", 
            AbilityName='RULEUCC_Research',
            TaskName='RULEUCC_Research',
            cursor = 'ATTACK_MOVE',
        }
        import('/lua/ui/game/commandmode.lua').StartCommandMode("order", modeData)
    end
...
local defaultOrdersTable = {
	...
	RULEUCC_Research = {      		helpText = "toggle_cloak",      bitmapId = 'Research',        		preferredSlot = 8, behavior = ResearchLaunch},
